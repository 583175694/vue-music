...
export default {
  ...
  methods: {
    // 点击右上角返回按钮，将 fullScreen的状态设为false
    back() {
      this.setFullScreen(false)
    },
    // 点击 mini播放器，将 fullScreen的状态设为true
    open() {
    ...
    // audio timeupdate属性的方法，返回视频或音频的播放位置
    updateTime(e) {
    ...
    // 播放器的cd 和 mini播放器cd的初始位置和要移动的位置
    _getPosAndScale() {
